 ...
 */
metadata {
	definition (name: "mPower Virtual Switch", namespace: "lcf", author: "Patrick Stuart") {
		capability "Actuator"
		capability "Switch"
		capability "Polling"
		capability "Refresh"
...
def on() {
    ...
    parent.virtualOn(device.deviceNetworkId)
...
def off() {
    ...
    parent.virtualOff(device.deviceNetworkId)
